...
class ProductTitleWithImageMyAds extends StatefulWidget {
  const ProductTitleWithImageMyAds({
    Key key,
...
class _ProductTitleWithImageState extends State<ProductTitleWithImageMyAds> {
  int _current = 0;
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.only(bottom: size * 0.214),
                child: RichText(
                  //DEO SA CENOM
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "${widget.product.priceRsd} din / ${widget.product.measuringUnit}\n",
                        style:  TextStyle(
                            color:Colors.white,
                            fontWeight:FontWeight.bold,
                            fontSize: 20,
                      ...
                      TextSpan(
                        text: "${widget.product.priceEth}".isEmpty?'/':'${widget.product.priceEth} eth / ${widget.product.measuringUnit}\n',
                        style:  TextStyle(
                            color:Colors.white,
                            fontWeight:FontWeight.bold,
                            fontSize: 20,
    ...
    return Scaffold(
      body: GestureDetector(
        child: Center(
          child: Hero(
            tag: 'imageHero',
            child: Image(image: product.images[0],),
          ),
        ),
        onTap: () {
