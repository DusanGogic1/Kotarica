...
class AddAdvertPageOne extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<AddAdvertPageOne> {
  // controllers
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton(
                        ...
                        dropdownColor: Tema.dark? darkPozadina:Colors.white,
                        //elevation: 5,
                        icon: Icon(
  ...
  Widget buildTextField(String hintText) {
    return TextField(
      ...
      decoration: InputDecoration(
        // fillColor: Tema.dark? bela: Colors.black,
        hintText: hintText,
        hintStyle: TextStyle(
      ...
      onTap: () {
        if (_titleController.text == "")
          ...
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                  builder: (BuildContext context) => AddAdvertPageTwo(
