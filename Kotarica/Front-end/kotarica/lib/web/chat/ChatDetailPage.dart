...
import 'package:kotarica/chat/models/SendMenuItems.dart';
...
class ChatDetailPageWeb extends StatefulWidget {
  int advertId;
  int otherId;
  String otherUsername;

  ChatDetailPageWeb(this.advertId, this.otherId, this.otherUsername);

  @override
  _ChatDetailPageWebState createState() =>
      _ChatDetailPageWebState(advertId, otherId, otherUsername);
}

class _ChatDetailPageWebState extends State<ChatDetailPageWeb> {
  int advertId;
  int otherId;
  String otherUsername;
  ...
  _ChatDetailPageWebState(this.advertId, this.otherId, this.otherUsername);
  ...
  Widget build(BuildContext context) {
    ...
    /*String punoIme = ProductModelWeb.totalProducts[advertId].ownerId==widget.otherId?
    ("Prodavac: "+widget.otherUsername + "\nProizvod: " + ProductModelWeb.totalProducts[advertId].title):
            ...
            flexibleSpace: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.data != null) {
                    return ChatDetailPageAppBarWeb(snapshot.data, advertId);
                  } else
                    return Text("");
                }),
          )),
      /*ChatDetailPageWebAppBar(punoIme, advertId),*/
      body: Stack(
        children: <Widget>[
          // isLoading
          //   ? Center(
          ...
          /* ------- INPUT ZA PORUKU ------*/
          if (ProductModelWeb.totalProducts[advertId] != null)
            Align(
