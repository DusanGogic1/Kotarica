...
class BuyingModelWeb extends ChangeNotifier{
  ...
  Future<List> getAllPendingBuyer() async {
    ...
    for(int i = 0; i < pa[0].toInt(); i++){
      ...
      if(pendingProduct[0].toInt() == buyerId && pendingProduct[5] != "")
  ...
  Future<void> sendEther(int amount, double priceEth, String ownerUsername, BuildContext context) async {
    ...
    EthereumAddress seller = await Provider.of<UserModelWeb>(context, listen: false).GetOwnerInfo(ownerUsername);
