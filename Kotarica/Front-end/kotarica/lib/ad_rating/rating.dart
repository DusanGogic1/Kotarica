...
class _State extends State<RatingPage> {
  int username;
  int ID;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          {
             await marksUserModel.addDislike(ime, widget.username, _izabranoMsg1,_izabranoMsg2, _izabranoMsg3);
          }
          else //lajkujemo
          {
            await marksUserModel.addLike(ime, widget.username, _izabranoMsg1,_izabranoMsg2, _izabranoMsg3);
          }
          //
          showLoadingDialog(context);

          await marksProductModel.addMarks(_iconRating, widget.ID);
          _FinishRating();
