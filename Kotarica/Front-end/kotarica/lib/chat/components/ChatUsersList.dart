...
import 'package:kotarica/chat/ChatPage.dart';
...
class ChatUsersList extends StatefulWidget {
  ...
  _ChatUsersListState createState() =>
      _ChatUsersListState(advertId, myId, otherId, otherUsername);
}
...
class _ChatUsersListState extends State<ChatUsersList> {
        ...
        onTap: () {
          Navigator.of(context)
            .push(MaterialPageRoute(
                builder: (context) =>
                    ChatDetailPage(advertId, otherId, otherUsername)))
  ...
  Future<void> _reload(var value) async {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => MainPageChat()));
  }
}
